...
function logDayCandle(dayCandle, ema) {
    return __awaiter(this, void 0, void 0, function () {
        var section, _i, _a, _b, key, value;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    for (_i = 0, _a = Object.entries(dayCandle); _i < _a.length; _i++) {
...
function logQuarterCandle(quarterCandle) {
    return __awaiter(this, void 0, void 0, function () {
        var section, _i, _a, _b, key, value, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    // start line
                    for (_i = 0, _a = Object.entries(quarterCandle); _i < _a.length; _i++) {
                        _b = _a[_i], key = _b[0], value = _b[1];
                        section.push({
                            type: "section",
                            text: {
