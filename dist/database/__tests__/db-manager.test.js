...
//   })
// })
describe('DbManager class getItem function', function () {
    it('should fetch item specified key', function () { return __awaiter(void 0, void 0, void 0, function () {
        var params, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, __1.default.getItem(params)];
                case 1:
                    result = _a.sent();
                    console.log(result);
                    expect(result).not.toBe(undefined);
                    expect(result === null || result === void 0 ? void 0 : result.$metadata.httpStatusCode).toBe(200);
                    return [2 /*return*/];
            }
        });
    }); });
